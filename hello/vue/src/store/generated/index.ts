...
import XxxxxchanHelloXxxxxchanHelloHello from './xxxxxchan/hello/xxxxxchan.hello.hello'
...
export default { 
  ...
  XxxxxchanHelloXxxxxchanHelloHello: load(XxxxxchanHelloXxxxxchanHelloHello, 'xxxxxchan.hello.hello'),
